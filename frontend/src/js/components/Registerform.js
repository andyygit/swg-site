    ...
    this.innerHTML = `
      <div id="register-form" class="mx-4 mt-24 md:max-w-1/2 md:mx-auto p-8 rounded-2xl inset-ring inset-ring-gray-200 shadow-xl/30">
        <div class="grid gap-5">
          ...
          <p class="text-black/70 text-sm font-light italic"><i class="fa-solid fa-circle-exclamation text-red-700"></i> Site destinat adultilor! Prin utilizarea funcționalității de creare cont nou și
